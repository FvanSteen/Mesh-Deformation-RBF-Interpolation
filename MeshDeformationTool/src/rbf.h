...
//	Eigen::ArrayXi sNodes;
//	const std::string smode, pmode;

//	Eigen::VectorXd rotVec;
//	Eigen::VectorXd pVec, pnVec;
//	const bool curved;
//	const std::string perDir;
//	const bool dataRed;
//	rbf(Mesh* meshPtr, Eigen::VectorXd& displacementVector, Eigen::VectorXd& rVec, const int steps, Eigen::RowVectorXd& rotationPnt, const std::string& slidingMode, const bool& curved, const std::string& periodicDirection, const bool& dataReduction);
	rbf(Mesh& meshObject, probParams& probParamsObject);

	void RBFMain();

//	void RBF_standard(rbfGenFunc *ptr);
//	void performRBF(Eigen::MatrixXd& Phi_mm, Eigen::MatrixXd& Phi_im, Eigen::VectorXd& defVec, Eigen::ArrayXi& movingNodes, int& N,rbfGenFunc *ptr);
